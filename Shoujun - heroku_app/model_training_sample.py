...
x_train_sample=pd.read_csv('x_train_sample.csv',header=None).iloc[:,0]
y_train_sample=pd.read_csv('y_train_sample.csv',header=None).iloc[:,0]
...
def logreg():
    ...
    tfidf_vectorizer = TfidfVectorizer(analyzer='word', lowercase=False, ngram_range=(1,3),max_features=40000)
